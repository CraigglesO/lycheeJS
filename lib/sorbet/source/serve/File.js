...
lychee.define('sorbet.serve.File').requires([
	...
	var _public_filesystem     = new sorbet.data.Filesystem('/lib/sorbet/public');
	var _cultivator_filesystem = new sorbet.data.Filesystem('/projects/cultivator');
	...
	var Module = {
		...
		can: function(host, url) {
			...
			// /lib/breeder, /lib/lychee, /lib/sorbet
			if (url.substr(0, 4) === '/lib') {
		...
		process: function(host, url, data, ready) {
			...
			// /*
				...
				var tmp = host.projects.filter(function(object) {
