...
lychee.define('app.net.Server').requires([
	...
	var Class = function(data) {
		...
		this.bind('connect', function(remote) {
			...
			console.log('(emoji-chat) app.net.Server: Remote connected (' + remote.host + ':' + remote.port + ')');
		...
		this.bind('disconnect', function(remote) {
			...
			console.log('(emoji-chat) app.net.Server: Remote disconnected (' + remote.host + ':' + remote.port + ')');
